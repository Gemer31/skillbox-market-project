    ...
    <form class="filter__form form" action="#" method="get">
      <fieldset class="form__block">
        ...
        <label for="priceFromId" class="form__label form__label--price">
          <input id="priceFromId" class="form__input" type="text" name="min-price" value="0">
          <span class="form__value">От</span>
        </label>
        <label for="priceToId" class="form__label form__label--price">
          <input id="priceToId" class="form__input" type="text" name="max-price" value="12345">
      ...
      <fieldset class="form__block">
        ...
        <label for="categoriesSelectId" class="form__label form__label--select">
          <select id="categoriesSelectId" class="form__select" type="text" name="category">
